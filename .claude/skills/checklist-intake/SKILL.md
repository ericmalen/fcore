...
description: Orchestration quality-flywheel intake — turns one shipped bug report or substantive review finding from an orchestration-generated repo into exactly one new item in that repo's docs/orchestration/checklists/review-checklist.md, which the generated code-reviewer applies on every review. Use when a bug or review finding from orchestration-generated work needs to feed the review checklist. Not for general retrospectives, FleetCore-development bugs, or findings outside orchestration-generated repos; not for editing or reorganizing existing checklist items.
---
...
1. **Triage first.** If the root cause is a defect in an FleetCore template,

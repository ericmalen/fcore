...
- Each paired skill's template:
  `templates/orchestration/skills/<skillId>.template.md` in the fcore checkout.
...
files. Fixes belong upstream in the blueprint or the FleetCore template.

#!/usr/bin/env node
// rule-check-map — R-51 integrity gate for the FleetCore repo's own CI.
//
...
//
// Rules enforced elsewhere (enforcement column = "FleetCore CI", e.g. R-51 itself)
...
export function run(root = fcoreRoot) {

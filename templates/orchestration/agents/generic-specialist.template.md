...
description: Layer specialist for the <!-- ai-kit:slot:stack --> code under <!-- ai-kit:slot:layer-path -->. Invoke when the orchestrator dispatches a task scoped to this layer; implements the change, proves it with the layer's tests, and reports back. Never touches shared orchestration state.
tools: <!-- ai-kit:slot:tools -->
model: <!-- ai-kit:slot:model-tier -->
---

Implements changes in `<!-- ai-kit:slot:layer-path -->`
